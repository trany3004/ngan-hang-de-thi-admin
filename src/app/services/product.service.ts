...
export class ProductService extends BaseService {
  ...
  fetchSystemInventoryProduct(productId): Observable<any[]> {
    return this.http.get<any[]>(`/api/v2/system-inventories?pg_product=${productId}`);
  }

  updateQuantities(data): Observable<any> {
    return this.http.put<any>(`/api/v1/inventories/addToStocks`, data);
  }
}
